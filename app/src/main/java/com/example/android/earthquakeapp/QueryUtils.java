...
/**
 * Created by Thanassis on 22/1/2018.
 */
...
public final class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        // TESTING : FORCING THE BACKGROUND THREAD TO SLEEP FOR 5 SECONDS ( to see the loading Indicator )
        /*
        try {
            Thread.sleep(5000);
    ...
    public static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        // Create an empty LinkedList that we can start adding earthquakes to
        ...
        try {
            ...
            // Loop through Array to get its individual data in an JSONObeject
